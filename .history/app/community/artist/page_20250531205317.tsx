...
const CommunityArtistPage = async () => {
  ...
  return (
    <div>
      ...
      {/* POST */}
      <div className="flex px-10 py-2 relative justify-between mt-10 border border-slate-500 h-20 rounded-full">
        <div className="flex items-center border-l border-primary/50">
          <p className="ml-3">SENT MESSAGE</p>
        </div>
        <div className="border-l text-primary/50 space-x-4 flex items-center border-primary/50">
          <ImageUpIcon />
          <GrEmoji />
        </div>
      </div>
