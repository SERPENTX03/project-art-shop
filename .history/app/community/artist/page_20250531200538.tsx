...
const CommunityArtistPage = async () => {
  ...
  return (
    <nav className="flex relative justify-between mt-10 border border-slate-500 h-20 rounded-full">
      ...
      <div className=" absolute right-0 top-0 border border-l-slate-500 border-y-slate-500 h-full w-[80px] rounded-full flex justify-center items-center text-2xl">
